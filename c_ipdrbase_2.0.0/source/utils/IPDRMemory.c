...
RecordDescriptor* newRecordDescriptor(void)
{
	...
	pRecordDescriptor->pListServiceAttributeDescriptor_ = NULL;
		...
		) 
{
	...
	case IPDRDATA_BOOLEAN:
		...
		strcpy((char *) pListIPDRData->IPDRDataUnion_.IPDRBoolean_, 
		dataValue);
		pListIPDRData->IPDRDataType_ = dataType;
		break;

	case IPDRDATA_SHORT:
		pListIPDRData->IPDRDataUnion_.IPDRShort_ = (int) dataValue;
		pListIPDRData->IPDRDataType_ = dataType;
		break;

	case IPDRDATA_USHORT:
		pListIPDRData->IPDRDataUnion_.IPDRUShort_ = (unsigned int) dataValue;
		pListIPDRData->IPDRDataType_ = dataType;
		break;
...
) 
{
	...
	case IPDRDATA_SHORT:
		/*pListIPDRData->IPDRDataUnion_.IPDRShort_ = *((short int *) dataValue);*/
		pListIPDRData->IPDRDataUnion_.IPDRShort_ = (int) dataValue;
		pListIPDRData->IPDRDataType_ = dataType;
		break;

	case IPDRDATA_USHORT:
		/*pListIPDRData->IPDRDataUnion_.IPDRUShort_ = *((unsigned short int *) dataValue);*/
		pListIPDRData->IPDRDataUnion_.IPDRUShort_ = (unsigned int) dataValue;
		pListIPDRData->IPDRDataType_ = dataType;
		break;
	...
	case IPDRDATA_BYTE:
	case IPDRDATA_UBYTE:
		pListIPDRData->IPDRDataUnion_.IPDRByte_ = (int)dataValue;
		pListIPDRData->IPDRDataType_ = dataType;
		break;
...
) 
{
   ...
   int count;
	...
	case IPDRDATA_ARRAY:
		pListIPDRData->IPDRDataType_ = dataType;
		pListIPDRData->noOfElements_ = noOfElements;
		pListIPDRData->pListIPDRArrayData_ = pListIPDRArrayData;
		break;
...
) 
{
   ...
   int count;
	...
	case IPDRDATA_STRUCTURE:
		pListIPDRData->IPDRDataType_ = dataType;
		pListIPDRData->pListIPDRStructureData_ = pListIPDRStructureData;
		break;
...
) 
{
   ...
   int cnt;
	...
	if(dataValue == NULL) {
		for(count = 0; dataType != NULL; count++) {
			if (dataType[count] == 7 || dataType[count] == 8) {
		    	return (IPDR_NULL_INPUT_PARAMETER);
			}
		}
	}
	...
	switch ((int)dataType[0])
	{
	case IPDRDATA_LONG:
		pListIPDRData->IPDRDataUnion_.IPDRLong_ = (int)dataValue[0];
		pListIPDRData->IPDRDataType_ = dataType[0];
		break;
	...
	case IPDRDATA_LONGLONG:
		pListIPDRData->IPDRDataUnion_.IPDRLongLong_ = *((hyper *)dataValue[0]);
		pListIPDRData->IPDRDataType_ = dataType[0];
		break;

	case IPDRDATA_ULONGLONG:
		pListIPDRData->IPDRDataUnion_.IPDRULongLong_ = 
			*((unsigned hyper *)dataValue[0]);
		pListIPDRData->IPDRDataType_ = dataType[0];
		break;

	case IPDRDATA_FLOAT:
		pListIPDRData->IPDRDataUnion_.IPDRFloat_ = *((float *) dataValue[0]);
		pListIPDRData->IPDRDataType_ = dataType[0];
		break;


	case IPDRDATA_DOUBLE:
		pListIPDRData->IPDRDataUnion_.IPDRDouble_ = *((double *) dataValue[0]);
		pListIPDRData->IPDRDataType_ = dataType[0];
		break;
	...
	case IPDRDATA_ARRAY:
		pListIPDRData->IPDRDataType_ = dataType[0];
		for(count = 0,cnt=1; dataValue[count] != NULL; count++) {
			appendListIPDRArrayData(&pListIPDRData->pListIPDRArrayData_, dataValue[count], dataType[1]);
		}
		pListIPDRData->noOfElements_ = count;
	...
	case IPDRDATA_STRUCTURE:
		/*
		pListIPDRData->IPDRDataType_ = dataType[0];
		for(count = 0,cnt=1; dataValue[count] != NULL; count++,cnt++) {
			appendListIPDRComplexData(&pListIPDRData->pListIPDRComplexData_, dataValue[count], dataType[cnt]);
		}
		*/
		break;
	...
	case IPDRDATA_SHORT:
		pListIPDRData->IPDRDataUnion_.IPDRShort_ = (int)dataValue[0];
		pListIPDRData->IPDRDataType_ = dataType[0];
		break;

	case IPDRDATA_USHORT:
		pListIPDRData->IPDRDataUnion_.IPDRUShort_ = (unsigned int) dataValue[0];
		pListIPDRData->IPDRDataType_ = dataType[0];
		break;

	case IPDRDATA_BYTE:
		pListIPDRData->IPDRDataUnion_.IPDRByte_ = (int)dataValue[0];
		pListIPDRData->IPDRDataType_ = dataType[0];
		break;
	...
	*pHeadRef = pListIPDRData; 
	...
	case IPDRDATA_ARRAY:
		for(count = 0,cnt=1; dataValue[count] != NULL; count++) {
			appendListIPDRArrayData(&pListIPDRData->pListIPDRArrayData_, dataValue[count], dataType[cnt]);
		}
		pListIPDRData->IPDRDataType_ = dataType[0];
		pListIPDRData->noOfElements_ = count;
		break;
...
{
	ListIPDRComplexData* pListIPDRComplexData = NULL;
	ListIPDRComplexData* pCurrent = *pHeadRef;
   ...
   int count;
	...
	if (pCurrent == NULL) {
		pListIPDRComplexData = (ListIPDRComplexData *)
	                 calloc (1, sizeof(struct ListIPDRComplexData));
	...
	{
	case IPDRDATA_STRUCTURE:
		pListIPDRComplexData->IPDRDataType_ = dataType;

		pCurrentListIPDRComplex = pListIPDRComplex;
		while(pListIPDRComplex != NULL) {
			appendListIPDRComplexToComplexData(&pListIPDRComplexData->pListIPDRComplex_, pListIPDRComplex);
			pListIPDRComplex = pListIPDRComplex->pNext_;
		}
		pListIPDRComplex = pCurrentListIPDRComplex;
	...
	pListIPDRComplexData->pNext_ = *pHeadRef; 
	*pHeadRef = pListIPDRComplexData; 
	...
	pListIPDRComplexData->pNext_ = NULL; 
	pCurrent->pNext_ = pListIPDRComplexData; 

	}
	return (IPDR_OK);
}

appendListIPDRComplexToComplexData(ListIPDRComplex** pHeadRef, ListIPDRComplex* pListIPDRComplex)
{
	ListIPDRComplex* plListIPDRComplex = NULL;
	ListIPDRComplex* pCurrent = *pHeadRef;
	ListIPDRArrayData* pCurrentListIPDRArrayData = NULL;
   int count;
	...
	if (pCurrent == NULL) {
		plListIPDRComplex = (ListIPDRComplex *)
	                 calloc (1, sizeof(struct ListIPDRComplex));

		if (pHeadRef == NULL) {
			return (IPDR_NULL_INPUT_PARAMETER);
		}

		plListIPDRComplex->IPDRDataType_ = pListIPDRComplex->IPDRDataType_;
		plListIPDRComplex->noOfElements_ = pListIPDRComplex->noOfElements_;

		pCurrentListIPDRArrayData = pListIPDRComplex->pListIPDRArrayData_;
		while(pListIPDRComplex->pListIPDRArrayData_ != NULL) {
				appendListIPDRArrayDataToComplexData(&plListIPDRComplex->pListIPDRArrayData_, 
											pListIPDRComplex->pListIPDRArrayData_->IPDRDataUnion_,
											pListIPDRComplex->pListIPDRArrayData_->IPDRDataType_);
				pListIPDRComplex->pListIPDRArrayData_ = pListIPDRComplex->pListIPDRArrayData_->pNext_;
		}
		pListIPDRComplex->pListIPDRArrayData_ = pCurrentListIPDRArrayData;
	
		plListIPDRComplex->pNext_ = *pHeadRef; 
		*pHeadRef = plListIPDRComplex; 
	}
   else {
		    while (pCurrent->pNext_ != NULL) {
		        pCurrent = pCurrent->pNext_;
			...
			plListIPDRComplex->pNext_ = NULL; 
			pCurrent->pNext_ = plListIPDRComplex; 
		}

	return (IPDR_OK);
}

appendListIPDRWithComplexData(struct ListIPDRData** pHeadRef, 
										...
										int dataType)
{
   ...
   int count;
	...
	case IPDRDATA_STRUCTURE:
		pListIPDRData->IPDRDataType_ = dataType;
		for(count = 0; pListIPDRComplexData[count] != NULL; count++) {
			appendListStrutureToIPDRData(&pListIPDRData->pListIPDRStructureData_, pListIPDRComplexData[count], dataType);
		}
		pListIPDRData->pListIPDRStructureData_->noOfElements_ = count;
		break;
...
{
	ListIPDRStructureData* pListIPDRStructureData = NULL;
	ListIPDRStructureData* pCurrent = *pHeadRef;
   int count;
	...
	if (pCurrent == NULL) {
		pListIPDRStructureData = (ListIPDRStructureData *)
	                 calloc (1, sizeof(struct ListIPDRStructureData));
	...
	{
	case IPDRDATA_STRUCTURE:
		appendListIPDRComplexData(&pListIPDRStructureData->pListIPDRComplexData_, pListIPDRComplexData->pListIPDRComplex_,IPDRDATA_STRUCTURE);
		break;
	...
	pListIPDRStructureData->pNext_ = *pHeadRef; 
	*pHeadRef = pListIPDRStructureData; 
	...
	pListIPDRStructureData->pNext_ = NULL; 
	pCurrent->pNext_ = pListIPDRStructureData; 
...
{
	ListIPDRArrayData* pListIPDRArrayData = NULL;
	ListIPDRArrayData* pCurrent = *pHeadRef;
   int count;
   int cnt;
	...
	if (pCurrent == NULL) {
		pListIPDRArrayData = (ListIPDRArrayData *)
	                 calloc (1, sizeof(struct ListIPDRArrayData));

	switch (dataType)
	{
	case IPDRDATA_LONG:
		pListIPDRArrayData->IPDRDataUnion_.IPDRLong_ = (int)dataValue;
		pListIPDRArrayData->IPDRDataType_ = dataType;
		break;

	case IPDRDATA_ULONG:
		pListIPDRArrayData->IPDRDataUnion_.IPDRULong_ = 
			(unsigned int)dataValue;
		pListIPDRArrayData->IPDRDataType_ = dataType;
		break;

	case IPDRDATA_LONGLONG:
		pListIPDRArrayData->IPDRDataUnion_.IPDRLongLong_ = *((hyper *)dataValue);
		pListIPDRArrayData->IPDRDataType_ = dataType;
		break;

	case IPDRDATA_ULONGLONG:
		pListIPDRArrayData->IPDRDataUnion_.IPDRULongLong_ = 
			*((unsigned hyper *)dataValue);
		pListIPDRArrayData->IPDRDataType_ = dataType;
		break;

	case IPDRDATA_FLOAT:
		pListIPDRArrayData->IPDRDataUnion_.IPDRFloat_ = *((float *) dataValue);
		pListIPDRArrayData->IPDRDataType_ = dataType;
		break;

	case IPDRDATA_DOUBLE:
		pListIPDRArrayData->IPDRDataUnion_.IPDRDouble_ = *((double *) dataValue);
		pListIPDRArrayData->IPDRDataType_ = dataType;
		break;

	case IPDRDATA_HEXADECARRAY:
		pListIPDRArrayData->IPDRDataUnion_.IPDRByteArray_ = 
			(byte *)calloc(MAX_IPDR_STRING, sizeof(char));
		strcpy((char *)pListIPDRArrayData->IPDRDataUnion_.IPDRByteArray_, 
			dataValue);
		pListIPDRArrayData->IPDRDataType_ = dataType;
		break;
	...
	case IPDRDATA_STRING:
		pListIPDRArrayData->IPDRDataUnion_.IPDRUTF8Array_ = 
		(wchar *)calloc(MAX_IPDR_STRING, sizeof(char));
		strcpy((char *) pListIPDRArrayData->IPDRDataUnion_.IPDRUTF8Array_, 
		dataValue);
		pListIPDRArrayData->IPDRDataType_ = dataType;
		break;

	case IPDRDATA_BOOLEAN:
		pListIPDRArrayData->IPDRDataUnion_.IPDRBoolean_ = 
			(bool *)calloc(1, sizeof(char));
		strcpy((char *)pListIPDRArrayData->IPDRDataUnion_.IPDRBoolean_, 
			dataValue);
		pListIPDRArrayData->IPDRDataType_ = dataType;
		break;

	case IPDRDATA_SHORT:
		pListIPDRArrayData->IPDRDataUnion_.IPDRShort_ = (int)dataValue;
		pListIPDRArrayData->IPDRDataType_ = dataType;
		break;

	case IPDRDATA_USHORT:
		pListIPDRArrayData->IPDRDataUnion_.IPDRUShort_ = (unsigned int) dataValue;
		pListIPDRArrayData->IPDRDataType_ = dataType;
		break;
	default:
		break;
	...
	pListIPDRArrayData->pNext_ = *pHeadRef; 
	*pHeadRef = pListIPDRArrayData; 
	...
	pListIPDRArrayData->pNext_ = NULL; 
	pCurrent->pNext_ = pListIPDRArrayData; 
...
) 
{
   ...
   int cnt;
	...
	if (pCurrent == NULL) {
		pListIPDRComplex = (ListIPDRComplex *)
	                 calloc (1, sizeof(struct ListIPDRComplex));
	...
	case IPDRDATA_LONG:
		for(count = 0,cnt=1; dataValue[count] != NULL; count++,cnt++) {
			appendListIPDRArrayData(&pListIPDRComplex->pListIPDRArrayData_, dataValue[count], dataType);
		}
		pListIPDRComplex->IPDRDataType_ = dataType;
		pListIPDRComplex->noOfElements_ = count;
		break;
	...
	pListIPDRComplex->pNext_ = *pHeadRef; 
	*pHeadRef = pListIPDRComplex; 
	...
	pListIPDRComplex->pNext_ = NULL; 
	pCurrent->pNext_ = pListIPDRComplex; 
...
) 
{
   ...
   int cnt;
	...
	{
	case IPDRDATA_LONG:
		pListIPDRArrayData->IPDRDataUnion_.IPDRLong_ = ipdrDataUnion.IPDRLong_;
		pListIPDRArrayData->IPDRDataType_ = dataType;
		break;

	case IPDRDATA_ULONG:
		pListIPDRArrayData->IPDRDataUnion_.IPDRULong_ = ipdrDataUnion.IPDRULong_;
		pListIPDRArrayData->IPDRDataType_ = dataType;
		break;

	case IPDRDATA_LONGLONG:
		pListIPDRArrayData->IPDRDataUnion_.IPDRLongLong_ = ipdrDataUnion.IPDRLongLong_;
		pListIPDRArrayData->IPDRDataType_ = dataType;
		break;

	case IPDRDATA_ULONGLONG:
		pListIPDRArrayData->IPDRDataUnion_.IPDRULongLong_ = ipdrDataUnion.IPDRULongLong_;
		pListIPDRArrayData->IPDRDataType_ = dataType;
		break;

	case IPDRDATA_FLOAT:
		pListIPDRArrayData->IPDRDataUnion_.IPDRFloat_ = ipdrDataUnion.IPDRFloat_;
		pListIPDRArrayData->IPDRDataType_ = dataType;
		break;

	case IPDRDATA_DOUBLE:
		pListIPDRArrayData->IPDRDataUnion_.IPDRDouble_ = ipdrDataUnion.IPDRDouble_;
		pListIPDRArrayData->IPDRDataType_ = dataType;
		break;
	...
	case IPDRDATA_STRING:
		...
		(wchar *)calloc(MAX_IPDR_STRING, sizeof(char));
		strcpy((char *) pListIPDRArrayData->IPDRDataUnion_.IPDRUTF8Array_, 
		(char *)ipdrDataUnion.IPDRUTF8Array_);
		pListIPDRArrayData->IPDRDataType_ = dataType;
		break;
	...
	case IPDRDATA_BOOLEAN:
		pListIPDRArrayData->IPDRDataUnion_.IPDRBoolean_ = 
			(bool *)calloc(1, sizeof(char));
		strcpy((char *)pListIPDRArrayData->IPDRDataUnion_.IPDRBoolean_, 
			ipdrDataUnion.IPDRBoolean_);
		pListIPDRArrayData->IPDRDataType_ = dataType;
		break;

	case IPDRDATA_SHORT:
		pListIPDRArrayData->IPDRDataUnion_.IPDRShort_ = ipdrDataUnion.IPDRShort_;
		pListIPDRArrayData->IPDRDataType_ = dataType;
		break;

	case IPDRDATA_USHORT:
		pListIPDRArrayData->IPDRDataUnion_.IPDRUShort_ = ipdrDataUnion.IPDRUShort_;
		pListIPDRArrayData->IPDRDataType_ = dataType;
		break;
	default:
		break;
...
int freeListIPDRData(ListIPDRData** pHeadRef)
{
    ...
    while (pCurrent != NULL) {
		...
		if (pCurrent->IPDRDataType_ == IPDRDATA_HEXADECARRAY)
			free(pCurrent->IPDRDataUnion_.IPDRByteArray_);  

		if ((pCurrent->IPDRDataType_ == IPDRDATA_STRING) || (pCurrent->IPDRDataType_ == 0)) {
			free(pCurrent->IPDRDataUnion_.IPDRUTF8Array_);  
		}
  
		if(pCurrent->IPDRDataType_ != 0) 
	    free(pCurrent);
       pCurrent = pNext;
    }
    free(pCurrent);
...
int freeListNodeIPDRData(ListIPDRData** pHeadRef, int node)
{
	...
	if (pCurrent->IPDRDataType_ == IPDRDATA_HEXADECARRAY)
		free(pCurrent->IPDRDataUnion_.IPDRByteArray_);  
	if (pCurrent->IPDRDataType_ == IPDRDATA_STRING) 
		free(pCurrent->IPDRDataUnion_.IPDRUTF8Array_);  
...
int printListIPDRData(ListIPDRData* pListIPDRData)
{
	...
	while (pCurrent != NULL) {
	    printf("\n\nDisplaying Record %d", count + 1);
			...
			if (pCurrent->IPDRDataType_ == IPDRDATA_BOOLEAN) 
				printf("\nIPDRBoolean_ \t= %s", 
				pCurrent->IPDRDataUnion_.IPDRBoolean_);
			if (pCurrent->IPDRDataType_ == IPDRDATA_SHORT) 
				printf("\nIPDRShort_ \t= %d", 
				pCurrent->IPDRDataUnion_.IPDRShort_);
			if (pCurrent->IPDRDataType_ == IPDRDATA_USHORT) 
				printf("\nIPDRUShort_ \t= %u", 
				pCurrent->IPDRDataUnion_.IPDRUShort_);
	    pCurrent = pCurrent->pNext_;	
	    count++;
	}
	return (IPDR_OK);
...
IPDRData* newIPDRData(int IPDRDataFlag)
{
	...
	if (IPDRDataFlag == IPDRDATA_HEXADECARRAY) {
		pIPDRData->IPDRDataUnion_.IPDRByteArray_ = 
			(byte *) calloc(MAX_IPDR_STRING, sizeof(char));
		pIPDRData->IPDRDataFlag_ = IPDRDataFlag;
	}
	if (IPDRDataFlag == IPDRDATA_BOOLEAN) {
		pIPDRData->IPDRDataUnion_.IPDRBoolean_ = 
			(bool *) calloc(3, sizeof(char));
		pIPDRData->IPDRDataFlag_ = IPDRDataFlag;
	}
	if (IPDRDataFlag == IPDRDATA_SHORT) {
		pIPDRData->IPDRDataUnion_.IPDRShort_ = 0;
		pIPDRData->IPDRDataFlag_ = IPDRDataFlag;
	}
	if (IPDRDataFlag == IPDRDATA_USHORT) {
		pIPDRData->IPDRDataUnion_.IPDRUShort_ = 0;
		pIPDRData->IPDRDataFlag_ = IPDRDataFlag;
	}
	if (IPDRDataFlag == IPDRDATA_STRING) {
		pIPDRData->IPDRDataUnion_.IPDRUTF8Array_ = 
		(wchar *) calloc(MAX_IPDR_STRING, sizeof(char));
		pIPDRData->IPDRDataFlag_ = IPDRDataFlag;
	}
	if (IPDRDataFlag == IPDRDATA_BYTE) {
		pIPDRData->IPDRDataUnion_.IPDRByte_ = 0;
		pIPDRData->IPDRDataFlag_ = IPDRDataFlag;
	}
	if (IPDRDataFlag == IPDRDATA_UBYTE) {
		pIPDRData->IPDRDataUnion_.IPDRByte_ = 0;
		pIPDRData->IPDRDataFlag_ = IPDRDataFlag;
	}
...
int freeIPDRData(IPDRData* pIPDRData)
{
	...
	if (pIPDRData->IPDRDataFlag_ == IPDRDATA_HEXADECARRAY) {
		free(pIPDRData->IPDRDataUnion_.IPDRByteArray_);
		pIPDRData->IPDRDataUnion_.IPDRByteArray_ = NULL;
	}
	
	if (pIPDRData->IPDRDataFlag_ == IPDRDATA_STRING) {
...
int printIPDRData(IPDRData* pIPDRData)
{
	...
	if (pIPDRData->IPDRDataFlag_ == IPDRDATA_STRING)
		printf("\nIPDR_UTF8ARRAY = %s", 
		pIPDRData->IPDRDataUnion_.IPDRUTF8Array_);
	if (pIPDRData->IPDRDataFlag_ == IPDRDATA_BOOLEAN) 
		printf("\nIPDRBoolean_ \t= %d", 
		pIPDRData->IPDRDataUnion_.IPDRBoolean_);
	if (pIPDRData->IPDRDataFlag_ == IPDRDATA_SHORT) 
		printf("\nIPDRShort_ \t= %d", 
		pIPDRData->IPDRDataUnion_.IPDRShort_);
	if (pIPDRData->IPDRDataFlag_ == IPDRDATA_USHORT) 
		printf("\nIPDRUShort_ \t= %u", 
		pIPDRData->IPDRDataUnion_.IPDRUShort_);
...
AttributeDescriptor* newAttributeDescriptor(void)
{
	...
	pAttrDescr->complexType_ = (char *) calloc (MAX_ATTRIBUTE_TYPE, sizeof(char));

	pAttrDescr->noOfElements_ = 0;
   pAttrDescr->pListAttrNameList_ = NULL;
   pAttrDescr->pListAttrClassList_ = NULL;
   pAttrDescr->pListAttrMaxOccursList_ = NULL;
...
int freeAttributeDescriptor(AttributeDescriptor* pAttributeDescriptor)
{
	...
	free(pAttributeDescriptor->complexType_);
	if (pAttributeDescriptor->pListAttrNameList_ != NULL) {
		freeList(&(pAttributeDescriptor->pListAttrNameList_));
		pAttributeDescriptor->pListAttrNameList_ = NULL;
	}
	if (pAttributeDescriptor->pListAttrClassList_ != NULL) {
		freeList(&(pAttributeDescriptor->pListAttrClassList_));
		pAttributeDescriptor->pListAttrClassList_ = NULL;
	}
	if (pAttributeDescriptor->pListAttrMaxOccursList_ != NULL) {
		freeList(&(pAttributeDescriptor->pListAttrMaxOccursList_));
		pAttributeDescriptor->pListAttrMaxOccursList_ = NULL;
	}
	...
	)
{
	...
	List* pCurrentListAttributeName = NULL; 
	List* pCurrentListAttributeClass = NULL; 
	List* pCurrentListAttributeMaxOccurs = NULL; 
   ...
   if(complexType != NULL) {
		...
		if (pListAttributeDescriptor->pAttributeDescriptor_->complexType_== 
			NULL) {
			return (IPDR_MEMORY_ALLOCATION_FAILED);
		}

		strcpy(pListAttributeDescriptor->pAttributeDescriptor_->complexType_,
               complexType);
   }


	pCurrentListAttributeName = attrNameList;
	while(attrNameList != NULL) {
		appendNode (&(pListAttributeDescriptor->pAttributeDescriptor_->pListAttrNameList_),
							 attrNameList->node);
		attrNameList = attrNameList->pNext;
	}
	attrNameList = pCurrentListAttributeName;

	pCurrentListAttributeClass = attrClassList;
	while(attrClassList != NULL) {
		appendNode (&(pListAttributeDescriptor->pAttributeDescriptor_->pListAttrClassList_),
							 attrClassList->node);
		attrClassList = attrClassList->pNext;
	}
	attrClassList = pCurrentListAttributeClass;

	pCurrentListAttributeMaxOccurs = attrMaxOccursList;
	while(attrMaxOccursList != NULL) {
		appendNode (&(pListAttributeDescriptor->pAttributeDescriptor_->pListAttrMaxOccursList_),
							 attrMaxOccursList->node);
		attrMaxOccursList = attrMaxOccursList->pNext;
	}
	attrMaxOccursList = pCurrentListAttributeMaxOccurs;

	pListAttributeDescriptor->pAttributeDescriptor_->noOfElements_ = noOfElements;
...
int freeListAttributeDescriptor(ListAttributeDescriptor** pHeadRef)
{
    ...
    while (pCurrent != NULL) {
		...
		free(pCurrent->pAttributeDescriptor_->complexType_);
    ...
    while (pListIPDRData != NULL) {
      ...
      appendListIPDRData(&pListFNFData->pXMLFNFData_->pListIPDRData_,
          ...
          IPDRDATA_USHORT);
    		...
    		appendListArrayToIPDRData(&pListFNFData->pXMLFNFData_->pListIPDRData_,
        		pListIPDRData->pListIPDRArrayData_,pListIPDRData->noOfElements_,
				IPDRDATA_ARRAY);
     }
     else if (pListIPDRData->IPDRDataType_ == IPDRDATA_STRUCTURE) {
        appendListStructureToIPDRData(&pListFNFData->pXMLFNFData_->pListIPDRData_,
...
XMLFNFData* newXMLFNFData(void)
{
	...
	pXMLFNFData->pListServiceAttributeDescriptor_ = NULL;
...
SchemaElement* newSchemaElement(void)
{
	...
	pSchemaElement->pListReference_ = NULL;
	pSchemaElement->pListMinOccurs_ = NULL;
	pSchemaElement->pListMaxOccurs_ = NULL;
	pSchemaElement->pAttributeOptional_ = 1;  
	pSchemaElement->noOfElements_ = 0;
					...
					)
{
	...
	List* pCurrentListReference = NULL; 
	List* pCurrentListMinOccurs = NULL; 
	List* pCurrentListMaxOccurs = NULL; 
	...
	if (complexAttributeType == NULL) {
		pSchemaElement->complexAttributeType_ = (char *) calloc (lenNULL, sizeof(char));
		strcpy(pSchemaElement->complexAttributeType_, IPDR_NULL);
	} else {
		lenAttributeType = strlen(complexAttributeType) + 1;
		pSchemaElement->complexAttributeType_ = (char *) calloc (lenAttributeType, sizeof(char));
		strcpy(pSchemaElement->complexAttributeType_, complexAttributeType);
	}
	...
	pCurrentListReference = pListReference_;
	while(pListReference_ != NULL) {
		appendNode (&(pSchemaElement->pListReference_),
							 pListReference_->node);
		pListReference_ = pListReference_->pNext;
	}
	pListReference_ = pCurrentListReference;

	pCurrentListMinOccurs = pListMinOccurs_;
	while(pListMinOccurs_ != NULL) {
		appendNode (&(pSchemaElement->pListMinOccurs_),
							 pListMinOccurs_->node);
		pListMinOccurs_ = pListMinOccurs_->pNext;
	}
	pListMinOccurs_ = pCurrentListMinOccurs;

	pCurrentListMaxOccurs = pListMaxOccurs_;
	while(pListMaxOccurs_ != NULL) {
		appendNode (&(pSchemaElement->pListMaxOccurs_),
							 pListMaxOccurs_->node);
		pListMaxOccurs_ = pListMaxOccurs_->pNext;
	}
	pListMaxOccurs_ = pCurrentListMaxOccurs;

	pSchemaElement->pAttributeOptional_ = pAttributeOptional_; 

   pSchemaElement->noOfElements_ = noOfElements_;
...
int freeSchemaElement(SchemaElement * pSchemaElement)
{
	...
	if (pSchemaElement->complexAttributeType_ != NULL) {
		free(pSchemaElement->complexAttributeType_); 
		pSchemaElement->complexAttributeType_ = NULL;
	}
	...
	if (pSchemaElement->pListReference_ != NULL) {
		freeList(&(pSchemaElement->pListReference_));
		pSchemaElement->pListReference_ = NULL;
	}

	if (pSchemaElement->pListMinOccurs_ != NULL) {
		freeList(&(pSchemaElement->pListMinOccurs_));
		pSchemaElement->pListMinOccurs_ = NULL;
	}

	if (pSchemaElement->pListMaxOccurs_ != NULL) {
		freeList(&(pSchemaElement->pListMaxOccurs_));
		pSchemaElement->pListMaxOccurs_ = NULL;
	}
...
int printSchemaElement(SchemaElement * pSchemaElement)
{
	...
	printf("\npSchemaElement->complexAttributeType_ = %s", 
	...
	printList(pSchemaElement->pListReference_); 
	printList(pSchemaElement->pListMinOccurs_); 
	printList(pSchemaElement->pListMaxOccurs_); 
	printf("\npSchemaElement->noOfElements_ = %d", 
...
SchemaLookup* newSchemaLookup(void)
{
	...
	pSchemaLookup->pListServiceElement_ = NULL;
...
int freeSchemaLookup(SchemaLookup* pSchemaLookup)
{
	...
	freeListSchemaElement(&(pSchemaLookup->pListServiceElement_));	
	free(pSchemaLookup);
						 ...
						 ComplexElement* pComplexElement)
{
	...
	initComplexElement(pListComplexElement->pComplexElement_,
                 ...
                 pComplexElement->plstReference_,
                 pComplexElement->plstMinOccurs_,
					...
					)
{
	...
	pCurrentListReference = plstReference_;
	while(plstReference_ != NULL) {
		appendNode (&(pComplexElement->plstReference_),
							 plstReference_->node);
		plstReference_ = plstReference_->pNext;
	}
	plstReference_ = pCurrentListReference;

	pCurrentListMinOccurs = plstMinOccurs_;
	while(plstMinOccurs_ != NULL) {
		appendNode (&(pComplexElement->plstMinOccurs_),
							 plstMinOccurs_->node);
		plstMinOccurs_ = plstMinOccurs_->pNext;
	}
	plstMinOccurs_ = pCurrentListMinOccurs;
...
ComplexElement* newComplexElement(void)
{
	...
	pComplexElement->plstReference_ = NULL;
	pComplexElement->plstMinOccurs_ = NULL;
...
{
	ListComplexElement* pCurrent;
	ListComplexElement* pNext_;
	...
	pCurrent = *pHeadRef;
        while (pCurrent != NULL) {
            pNext_ = pCurrent->pNext_;
	    freeComplexElement(pCurrent->pComplexElement_);
	    free(pCurrent);
	    pCurrent = pNext_;
    }
    free(pCurrent);
...
int freeComplexElement(ComplexElement * pComplexElement)
{
	...
	if (pComplexElement->attributeName_ != NULL) {
		free(pComplexElement->attributeName_);
		pComplexElement->attributeName_ = NULL;
	}

	if (pComplexElement->attributeType_ != NULL) {
		free(pComplexElement->attributeType_); 
		pComplexElement->attributeType_ = NULL;
	}

	if (pComplexElement->derivedType_ != NULL) {
		free(pComplexElement->derivedType_); 
		pComplexElement->derivedType_ = NULL;
	}

	if (pComplexElement->documentation_ != NULL) {
		free(pComplexElement->documentation_); 
		pComplexElement->documentation_ = NULL;
	}

	if (pComplexElement->reference_ != NULL) {
		free(pComplexElement->reference_); 
		pComplexElement->reference_ = NULL;
	}

	if (pComplexElement->status_ != NULL) {
		free(pComplexElement->status_); 
		pComplexElement->status_ = NULL;
	}

	if (pComplexElement->unit_ != NULL) {
		free(pComplexElement->unit_); 
		pComplexElement->unit_ = NULL;
	}

	if (pComplexElement->plstReference_ != NULL) {
		freeList(&(pComplexElement->plstReference_));
		pComplexElement->plstReference_ = NULL;
	}

	if (pComplexElement->plstMinOccurs_ != NULL) {
		freeList(&(pComplexElement->plstMinOccurs_));
		pComplexElement->plstMinOccurs_ = NULL;
	}

	if (pComplexElement->pListAttributeEnum_ != NULL) {
		freeList(&(pComplexElement->pListAttributeEnum_));
		pComplexElement->pListAttributeEnum_ = NULL;
	}

	free(pComplexElement);
															 ...
															 ListSchemaElement* pListSchemaElement)
{
   ...
   while(pCurrent->pComplexElement_->plstReference_ != NULL) {
      while(pListSchemaElement != NULL) {
   		if((strcmp(pListSchemaElement->pSchemaElement_->attributeName_, 
						  pCurrent->pComplexElement_->plstReference_->node) == 0)) {
			}
			pListSchemaElement = pListSchemaElement->pNext_;
		}
   	pCurrent->pComplexElement_->plstReference_ = pCurrent->pComplexElement_->plstReference_->pNext;	
	}
...
{
	int count = 0;
	ListComplexElement* pCurrent = pListComplexElement;

	if (pListComplexElement == NULL) {
		return (IPDR_NULL_INPUT_PARAMETER);
	}

	for (pCurrent = pListComplexElement; pCurrent != NULL; 
	pCurrent = pCurrent->pNext_)
		count++;
	return (count);
}
...
int printListComplexElement( ListComplexElement* pListComplexElement)
{
	...
	while (pCurrent != NULL) {
		printf("\n\n\nPrinting Schema Element %d", count + 1);
		printComplexElement(pCurrent->pComplexElement_); 
	    pCurrent = pCurrent->pNext_;	
	    count++;
	}
...
int printComplexElement(ComplexElement * pComplexElement)
{
	...
	printf("\npComplexElement->attributeName_ = %s", 
							pComplexElement->attributeName_);
	printf("\npComplexElement->attributeType_ = %s", 
							pComplexElement->attributeType_);
	printf("\npComplexElement->derivedType_ = %s", 
							pComplexElement->derivedType_);
	printf("\npComplexElement->documentation_ = %s", 
							pComplexElement->documentation_);
	printf("\npComplexElement->reference_ = %s", 
							pComplexElement->reference_);
	printf("\npComplexElement->status_ = %s", 
							pComplexElement->status_);
	printf("\npComplexElement->unit_ = %s", 
							pComplexElement->unit_);
	printList(pComplexElement->pListAttributeEnum_); 
	printList(pComplexElement->plstReference_); 
	printList(pComplexElement->plstMinOccurs_); 
...
{
	ListIPDRComplex* pCurrent;
	ListIPDRComplex* pNext;
    ...
    while (pCurrent != NULL) {
        pNext = pCurrent->pNext_;
		 ...
		 free(pCurrent->pListIPDRArrayData_);
		 pCurrent->pListIPDRArrayData_ = NULL;
	    free(pCurrent);
       pCurrent = pNext;
    }
    free(pCurrent);
...
{
	ListIPDRArrayData* pCurrent;
	ListIPDRArrayData* pNext;
...
{
	ListIPDRStructureData* pCurrent;
	ListIPDRStructureData* pNext;
    ...
    while (pCurrent != NULL) {
        pNext = pCurrent->pNext_;
		 ...
		 freeListIPDRComplexData(&(pCurrent->pListIPDRComplexData_));
	
		 free(pCurrent->pListIPDRComplexData_);	
		 pCurrent->pListIPDRComplexData_ = NULL;
	    free(pCurrent);
       pCurrent = pNext;
    }
    free(pCurrent);
...
{
	ListIPDRComplexData* pCurrent;
	ListIPDRComplexData* pNext;
    ...
    while (pCurrent != NULL) {
        pNext = pCurrent->pNext_;
		  ...
		  freeListIPDRComplex(&(pCurrent->pListIPDRComplex_));

		 free(pCurrent->pListIPDRComplex_);
		 pCurrent->pListIPDRComplex_ = NULL;
	    free(pCurrent);
       pCurrent = pNext;
    }
    free(pCurrent);
